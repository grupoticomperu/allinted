                                        ...
                                        <div class="flex-shrink-0 h-10 w-15 ">
                                            @if ($brandd->image)
                                                <img class="object-cover w-20 h-10 rounded-sm" src="{{url($brandd->image) }}" alt="">
                                                    {{-- src="{{ Storage::url($brand->image) }}" storage//storage/brands/default.jpg  en la bd esta puesto esto 	/storage/brands/default.jpg > --}}
                                                    {{-- para que muestre correcto Storage::url($brand->image) en la BD deberia estar puesto brands/default.jpg--}}
                                            ...
                                            @else
                                                <img class="object-cover w-20 h-10 rounded-sm"
                                                    src="/storage/brands/default2.jpg" alt="">
                                            @endif
                                        </div>
                                        <div class="ml-4">
                                            {{ $brandd->name }}
