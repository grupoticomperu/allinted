                                ...
                                <tr>
                                    ...
                                    <td class="flex items-center px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                                        ...
                                        <div class="flex-shrink-0 h-10 w-15 ">
                                            @if ($modeloo->image)
                                                <img class="object-cover w-20 h-10 rounded-sm" src="{{url($modeloo->image) }}" alt="">

                                            @else
                                                <img class="object-cover w-20 h-10 rounded-sm"
                                                    src="/storage/modeloss/default2.jpg" alt="">
                                            @endif
                                        </div>
                                        <div class="ml-4">
                                            {{ $modeloo->name }}
    ...
    <x-jet-dialog-modal wire:model="open_edit">
        ...
        <x-slot name="content">
            ...
            <div class="mb-4">
                ...
                <x-jet-input-error for="modelo.name"/>
            </div>
