<div>
                            ...
                            @foreach ($ums as $umm)
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                        <a wire:click="edit({{ $umm }})" class="btn btn-green"><i class="fa-solid fa-pen-to-square"></i></a>
                                        <a class="btn btn-red" wire:click="$emit('deleteUm', {{ $umm->id }})" >
    ...
    <x-jet-dialog-modal wire:model="open_edit">
        <x-slot name="title">
        Modificando la Unidad de Medida
        </x-slot>
        ...
        <x-slot name="content">
            ...
            <div class="mb-4">
                ...
                <x-jet-input type="text" class="w-full" wire:model="um.name" />
                <x-jet-input-error for="um.name"/>
            </div>

            <div class="mb-4">
                Estado
                <x-jet-input type="checkbox" wire:model="um.state" />
        ...
        Livewire.on('deleteUm', umId => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Livewire.emitTo('admin.um-list','delete',umId);
