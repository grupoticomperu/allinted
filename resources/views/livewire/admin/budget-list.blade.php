                                        ...
                                        @foreach ($budgets as $budget)
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                                    ...
                                                    <a class="btn btn-red" wire:click="$emit('deleteBrand', {{ $budget}})" >
